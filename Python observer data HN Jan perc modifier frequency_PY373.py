...
for dt, dataframe in enumerate(df_CB): 
    ...
    for position, col_name in enumerate(list_behaviors_social):
        ...
        for rank, perc in enumerate(list_intervals):
            data['%d_TNFF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_TNFF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_TNFF_%s'% (perc, col_name)]) 
            data['%d_TNFF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_treat_num']==1)&(data[MODTREAT]=='FLX-females')&(data['interval']==perc)), 
                data['obs_beh_int_treat_num_back'], data['%d_TNFF_%s'% (perc, col_name)]) 
            data['%d_TNFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_TNFF_%s'% (perc, col_name)]=np.where(data['%d_TNFF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_TNFF_%s'% (perc, col_name)])
            data['%d_TNFF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_TNFF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_TNFF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_TNFF_%s'% (perc, col_name)])
            data['%d_TNFF_%s'% (perc, col_name)]=np.where(data['%d_TNFF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_TNFF_%s'% (perc, col_name)])
            data['%d_TNFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_TNFF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_TNFF_%s'% (perc, col_name)])
     
       
            # Calculate total number of each "social" behavior directed at CTR female in total environment
            data['%d_TNCF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_TNCF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_TNCF_%s'% (perc, col_name)]) 
            data['%d_TNCF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_treat_num']==1)&(data[MODTREAT]=='CTR-females')&(data['interval']==perc)), 
                data['obs_beh_int_treat_num_back'], data['%d_TNCF_%s'% (perc, col_name)]) 
            data['%d_TNCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_TNCF_%s'% (perc, col_name)]=np.where(data['%d_TNCF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_TNCF_%s'% (perc, col_name)])
            data['%d_TNCF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_TNCF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_TNCF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_TNCF_%s'% (perc, col_name)])
            data['%d_TNCF_%s'% (perc, col_name)]=np.where(data['%d_TNCF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_TNCF_%s'% (perc, col_name)])
            data['%d_TNCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_TNCF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_TNCF_%s'% (perc, col_name)])
        
            # Calculate total number of each "social" behavior directed at FLX male in total environment
            data['%d_TNFM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_TNFM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_TNFM_%s'% (perc, col_name)]) 
            data['%d_TNFM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_treat_num']==1)&(data[MODTREAT]=='FLX-males')&(data['interval']==perc)), 
                data['obs_beh_int_treat_num_back'], data['%d_TNFM_%s'% (perc, col_name)]) 
            data['%d_TNFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_TNFM_%s'% (perc, col_name)]=np.where(data['%d_TNFM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_TNFM_%s'% (perc, col_name)])
            data['%d_TNFM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_TNFM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_TNFM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_TNFM_%s'% (perc, col_name)])
            data['%d_TNFM_%s'% (perc, col_name)]=np.where(data['%d_TNFM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_TNFM_%s'% (perc, col_name)])
            data['%d_TNFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_TNFM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_TNFM_%s'% (perc, col_name)])
        
            # Calculate total number of each "social" behavior directed at  CTR male in total environment
            data['%d_TNCM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_TNCM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_TNCM_%s'% (perc, col_name)]) 
            data['%d_TNCM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_treat_num']==1)&(data[MODTREAT]=='CTR-males')&(data['interval']==perc)), 
                data['obs_beh_int_treat_num_back'], data['%d_TNCM_%s'% (perc, col_name)]) 
            data['%d_TNCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_TNCM_%s'% (perc, col_name)]=np.where(data['%d_TNCM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_TNCM_%s'% (perc, col_name)])
            data['%d_TNCM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_TNCM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_TNCM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_TNCM_%s'% (perc, col_name)])
            data['%d_TNCM_%s'% (perc, col_name)]=np.where(data['%d_TNCM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_TNCM_%s'% (perc, col_name)])
            data['%d_TNCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
          
            # Calculate total number of each "social" behavior directed at FLX female in burrow
            data['%d_BNFF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_BNFF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_BNFF_%s'% (perc, col_name)]) 
            data['%d_BNFF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num']==1)&
                (data[MODTREAT]=='FLX-females')&(data[MODLOC]=='Burrow')&(data['interval']==perc)), data['obs_beh_int_loc_treat_num_back'], data['%d_BNFF_%s'% (perc, col_name)]) 
            data['%d_BNFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_BNFF_%s'% (perc, col_name)]=np.where(data['%d_BNFF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_BNFF_%s'% (perc, col_name)])
            data['%d_BNFF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_BNFF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_BNFF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_BNFF_%s'% (perc, col_name)])
            data['%d_BNFF_%s'% (perc, col_name)]=np.where(data['%d_BNFF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_BNFF_%s'% (perc, col_name)])
            data['%d_BNFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_BNFF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_BNFF_%s'% (perc, col_name)])
        
            # Calculate total number of each "social" behavior directed at CTR female in burrow
            data['%d_BNCF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_BNCF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_BNCF_%s'% (perc, col_name)]) 
            data['%d_BNCF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num']==1)&
                (data[MODTREAT]=='CTR-females')&(data[MODLOC]=='Burrow')&(data['interval']==perc)), data['obs_beh_int_loc_treat_num_back'], data['%d_BNCF_%s'% (perc, col_name)]) 
            data['%d_BNCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_BNCF_%s'% (perc, col_name)]=np.where(data['%d_BNCF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_BNCF_%s'% (perc, col_name)])
            data['%d_BNCF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_BNCF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_BNCF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_BNCF_%s'% (perc, col_name)])
            data['%d_BNCF_%s'% (perc, col_name)]=np.where(data['%d_BNCF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_BNCF_%s'% (perc, col_name)])
            data['%d_BNCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_BNCF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_BNCF_%s'% (perc, col_name)])
        
            # Calculate total number of each "social" behavior directed at FLX male in burrow
            data['%d_BNFM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_BNFM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_BNFM_%s'% (perc, col_name)]) 
            data['%d_BNFM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num']==1)&
                (data[MODTREAT]=='FLX-males')&(data[MODLOC]=='Burrow')&(data['interval']==perc)), data['obs_beh_int_loc_treat_num_back'], data['%d_BNFM_%s'% (perc, col_name)]) 
            data['%d_BNFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_BNFM_%s'% (perc, col_name)]=np.where(data['%d_BNFM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_BNFM_%s'% (perc, col_name)])
            data['%d_BNFM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_BNFM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_BNFM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_BNFM_%s'% (perc, col_name)])
            data['%d_BNFM_%s'% (perc, col_name)]=np.where(data['%d_BNFM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_BNFM_%s'% (perc, col_name)])
            data['%d_BNFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_BNFM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_BNFM_%s'% (perc, col_name)])
        
            # Calculate total number of each "social" behavior directed at CTR male in burrow
            data['%d_BNCM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_BNCM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_BNCM_%s'% (perc, col_name)]) 
            data['%d_BNCM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num']==1)&
                (data[MODTREAT]=='CTR-males')&(data[MODLOC]=='Burrow')&(data['interval']==perc)),data['obs_beh_int_loc_treat_num_back'], data['%d_BNCM_%s'% (perc, col_name)]) 
            data['%d_BNCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_BNCM_%s'% (perc, col_name)]=np.where(data['%d_BNCM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_BNCM_%s'% (perc, col_name)])
            data['%d_BNCM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_BNCM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_BNCM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_BNCM_%s'% (perc, col_name)])
            data['%d_BNCM_%s'% (perc, col_name)]=np.where(data['%d_BNCM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_BNCM_%s'% (perc, col_name)])
            data['%d_BNCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_BNCM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_BNCM_%s'% (perc, col_name)])
          
            # Calculate total number of each "social" behavior directed at FLX female in open field
            data['%d_ONFF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_ONFF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_ONFF_%s'% (perc, col_name)]) 
            data['%d_ONFF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num']==1)&
                (data[MODTREAT]=='FLX-females')&(data[MODLOC]=='Open field')&(data['interval']==perc)), data['obs_beh_int_loc_treat_num_back'], data['%d_ONFF_%s'% (perc, col_name)]) 
            data['%d_ONFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_ONFF_%s'% (perc, col_name)]=np.where(data['%d_ONFF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_ONFF_%s'% (perc, col_name)])
            data['%d_ONFF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_ONFF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_ONFF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_ONFF_%s'% (perc, col_name)])
            data['%d_ONFF_%s'% (perc, col_name)]=np.where(data['%d_ONFF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_ONFF_%s'% (perc, col_name)])
            data['%d_ONFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_ONFF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_ONFF_%s'% (perc, col_name)])
        
            # Calculate total number of each "social" behavior directed at CTR female in open field
            data['%d_ONCF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_ONCF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_ONCF_%s'% (perc, col_name)]) 
            data['%d_ONCF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num']==1)&
                (data[MODTREAT]=='CTR-females')&(data[MODLOC]=='Open field')&(data['interval']==perc)), data['obs_beh_int_loc_treat_num_back'], data['%d_ONCF_%s'% (perc, col_name)]) 
            data['%d_ONCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_ONCF_%s'% (perc, col_name)]=np.where(data['%d_ONCF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_ONCF_%s'% (perc, col_name)])
            data['%d_ONCF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_ONCF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_ONCF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_ONCF_%s'% (perc, col_name)])
            data['%d_ONCF_%s'% (perc, col_name)]=np.where(data['%d_ONCF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_ONCF_%s'% (perc, col_name)])
            data['%d_ONCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_ONCF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_ONCF_%s'% (perc, col_name)])
        
            # Calculate total number of each "social" behavior directed at FLX male in open field
            data['%d_ONFM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_ONFM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_ONFM_%s'% (perc, col_name)]) 
            data['%d_ONFM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num']==1)&
                (data[MODTREAT]=='FLX-males')&(data[MODLOC]=='Open field')&(data['interval']==perc)), data['obs_beh_int_loc_treat_num_back'], data['%d_ONFM_%s'% (perc, col_name)]) 
            data['%d_ONFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_ONFM_%s'% (perc, col_name)]=np.where(data['%d_ONFM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_ONFM_%s'% (perc, col_name)])
            data['%d_ONFM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_ONFM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_ONFM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_ONFM_%s'% (perc, col_name)])
            data['%d_ONFM_%s'% (perc, col_name)]=np.where(data['%d_ONFM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_ONFM_%s'% (perc, col_name)])
            data['%d_ONFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_ONFM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_ONFM_%s'% (perc, col_name)])
        
            # Calculate total number of each "social" behavior directed at CTR male in open field
            data['%d_ONCM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_ONCM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_ONCM_%s'% (perc, col_name)]) 
            data['%d_ONCM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num']==1)&
                (data[MODTREAT]=='CTR-males')&(data[MODLOC]=='Open field')&(data['interval']==perc)),data['obs_beh_int_loc_treat_num_back'], data['%d_ONCM_%s'% (perc, col_name)]) 
            data['%d_ONCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_ONCM_%s'% (perc, col_name)]=np.where(data['%d_ONCM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_ONCM_%s'% (perc, col_name)])
            data['%d_ONCM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_ONCM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_ONCM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_ONCM_%s'% (perc, col_name)])
            data['%d_ONCM_%s'% (perc, col_name)]=np.where(data['%d_ONCM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_ONCM_%s'% (perc, col_name)])
            data['%d_ONCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_ONCM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_ONCM_%s'% (perc, col_name)])
    ...
    for rank, perc in enumerate(list_intervals):
        ...
        data['%d_TNFF_%s'% (perc, EA)]= (data['%d_TNFF_%s'% (perc, BSD)]+data['%d_TNFF_%s'% (perc, BSE)]+data['%d_TNFF_%s'% (perc, BSF)])
        data['%d_TNFF_%s'% (perc, EB)]= (data['%d_TNFF_%s'% (perc, BSB)]/data['%d_TNFF_%s'% (perc, EA)]*100)
        data['%d_TNFF_%s'% (perc, EC)]= (data['%d_TNFF_%s'% (perc, BSG)]+data['%d_TNFF_%s'% (perc, BSH)]+data['%d_TNFF_%s'% (perc, BSI)])
        data['%d_TNFF_%s'% (perc, EE)]= (data['%d_TNFF_%s'% (perc, BCA)]+data['%d_TNFF_%s'% (perc, BCB)]+data['%d_TNFF_%s'% (perc, BCC)]+data['%d_TNFF_%s'% (perc, BCD)])
        data['%d_TNFF_%s'% (perc, EF)]= (data['%d_TNFF_%s'% (perc, BSA)]+data['%d_TNFF_%s'% (perc, BSB)])
        data['%d_TNFF_%s'% (perc, EG)]= (data['%d_TNFF_%s'% (perc, EF)]/data['%d_TNFF_%s'% (perc, EA)]*100)
        
        data['%d_ONFF_%s'% (perc, EA)]= (data['%d_ONFF_%s'% (perc, BSD)]+data['%d_ONFF_%s'% (perc, BSE)]+data['%d_ONFF_%s'% (perc, BSF)])
        data['%d_ONFF_%s'% (perc, EB)]= (data['%d_ONFF_%s'% (perc, BSB)]/data['%d_ONFF_%s'% (perc, EA)]*100)
        data['%d_ONFF_%s'% (perc, EC)]= (data['%d_ONFF_%s'% (perc, BSG)]+data['%d_ONFF_%s'% (perc, BSH)]+data['%d_ONFF_%s'% (perc, BSI)])
        data['%d_ONFF_%s'% (perc, EE)]= (data['%d_ONFF_%s'% (perc, BCA)]+data['%d_ONFF_%s'% (perc, BCB)]+data['%d_ONFF_%s'% (perc, BCC)]+data['%d_ONFF_%s'% (perc, BCD)])
        data['%d_ONFF_%s'% (perc, EF)]= (data['%d_ONFF_%s'% (perc, BSA)]+data['%d_ONFF_%s'% (perc, BSB)])
        data['%d_ONFF_%s'% (perc, EG)]= (data['%d_ONFF_%s'% (perc, EF)]/data['%d_ONFF_%s'% (perc, EA)]*100)
        
        data['%d_BNFF_%s'% (perc, EA)]= (data['%d_BNFF_%s'% (perc, BSD)]+data['%d_BNFF_%s'% (perc, BSE)]+data['%d_BNFF_%s'% (perc, BSF)])
        data['%d_BNFF_%s'% (perc, EB)]= (data['%d_BNFF_%s'% (perc, BSB)]/data['%d_BNFF_%s'% (perc, EA)]*100)
        data['%d_BNFF_%s'% (perc, EC)]= (data['%d_BNFF_%s'% (perc, BSG)]+data['%d_BNFF_%s'% (perc, BSH)]+data['%d_BNFF_%s'% (perc, BSI)])
        data['%d_BNFF_%s'% (perc, EE)]= (data['%d_BNFF_%s'% (perc, BCA)]+data['%d_BNFF_%s'% (perc, BCB)]+data['%d_BNFF_%s'% (perc, BCC)]+data['%d_BNFF_%s'% (perc, BCD)])
        data['%d_BNFF_%s'% (perc, EF)]= (data['%d_BNFF_%s'% (perc, BSA)]+data['%d_BNFF_%s'% (perc, BSB)])
        data['%d_BNFF_%s'% (perc, EG)]= (data['%d_BNFF_%s'% (perc, EF)]/data['%d_BNFF_%s'% (perc, EA)]*100)
        
        data['%d_TNCF_%s'% (perc, EA)]= (data['%d_TNCF_%s'% (perc, BSD)]+data['%d_TNCF_%s'% (perc, BSE)]+data['%d_TNCF_%s'% (perc, BSF)])
        data['%d_TNCF_%s'% (perc, EB)]= (data['%d_TNCF_%s'% (perc, BSB)]/data['%d_TNCF_%s'% (perc, EA)]*100)
        data['%d_TNCF_%s'% (perc, EC)]= (data['%d_TNCF_%s'% (perc, BSG)]+data['%d_TNCF_%s'% (perc, BSH)]+data['%d_TNCF_%s'% (perc, BSI)])
        data['%d_TNCF_%s'% (perc, EE)]= (data['%d_TNCF_%s'% (perc, BCA)]+data['%d_TNCF_%s'% (perc, BCB)]+data['%d_TNCF_%s'% (perc, BCC)]+data['%d_TNCF_%s'% (perc, BCD)])
        data['%d_TNCF_%s'% (perc, EF)]= (data['%d_TNCF_%s'% (perc, BSA)]+data['%d_TNCF_%s'% (perc, BSB)])
        data['%d_TNCF_%s'% (perc, EG)]= (data['%d_TNCF_%s'% (perc, EF)]/data['%d_TNCF_%s'% (perc, EA)]*100)
        
        data['%d_ONCF_%s'% (perc, EA)]= (data['%d_ONCF_%s'% (perc, BSD)]+data['%d_ONCF_%s'% (perc, BSE)]+data['%d_ONCF_%s'% (perc, BSF)])
        data['%d_ONCF_%s'% (perc, EB)]= (data['%d_ONCF_%s'% (perc, BSB)]/data['%d_ONCF_%s'% (perc, EA)]*100)
        data['%d_ONCF_%s'% (perc, EC)]= (data['%d_ONCF_%s'% (perc, BSG)]+data['%d_ONCF_%s'% (perc, BSH)]+data['%d_ONCF_%s'% (perc, BSI)])
        data['%d_ONCF_%s'% (perc, EE)]= (data['%d_ONCF_%s'% (perc, BCA)]+data['%d_ONCF_%s'% (perc, BCB)]+data['%d_ONCF_%s'% (perc, BCC)]+data['%d_ONCF_%s'% (perc, BCD)])
        data['%d_ONCF_%s'% (perc, EF)]= (data['%d_ONCF_%s'% (perc, BSA)]+data['%d_ONCF_%s'% (perc, BSB)])
        data['%d_ONCF_%s'% (perc, EG)]= (data['%d_ONCF_%s'% (perc, EF)]/data['%d_ONCF_%s'% (perc, EA)]*100)
        
        data['%d_BNCF_%s'% (perc, EA)]= (data['%d_BNCF_%s'% (perc, BSD)]+data['%d_BNCF_%s'% (perc, BSE)]+data['%d_BNCF_%s'% (perc, BSF)])
        data['%d_BNCF_%s'% (perc, EB)]= (data['%d_BNCF_%s'% (perc, BSB)]/data['%d_BNCF_%s'% (perc, EA)]*100)
        data['%d_BNCF_%s'% (perc, EC)]= (data['%d_BNCF_%s'% (perc, BSG)]+data['%d_BNCF_%s'% (perc, BSH)]+data['%d_BNCF_%s'% (perc, BSI)])
        data['%d_BNCF_%s'% (perc, EE)]= (data['%d_BNCF_%s'% (perc, BCA)]+data['%d_BNCF_%s'% (perc, BCB)]+data['%d_BNCF_%s'% (perc, BCC)]+data['%d_BNCF_%s'% (perc, BCD)])
        data['%d_BNCF_%s'% (perc, EF)]= (data['%d_BNCF_%s'% (perc, BSA)]+data['%d_BNCF_%s'% (perc, BSB)])
        data['%d_BNCF_%s'% (perc, EG)]= (data['%d_BNCF_%s'% (perc, EF)]/data['%d_BNCF_%s'% (perc, EA)]*100)
        
        data['%d_TNFM_%s'% (perc, EA)]= (data['%d_TNFM_%s'% (perc, BSD)]+data['%d_TNFM_%s'% (perc, BSE)]+data['%d_TNFM_%s'% (perc, BSF)])
        data['%d_TNFM_%s'% (perc, EB)]= (data['%d_TNFM_%s'% (perc, BSB)]/data['%d_TNFM_%s'% (perc, EA)]*100)
        data['%d_TNFM_%s'% (perc, EC)]= (data['%d_TNFM_%s'% (perc, BSG)]+data['%d_TNFM_%s'% (perc, BSH)]+data['%d_TNFM_%s'% (perc, BSI)])
        data['%d_TNFM_%s'% (perc, EE)]= (data['%d_TNFM_%s'% (perc, BCA)]+data['%d_TNFM_%s'% (perc, BCB)]+data['%d_TNFM_%s'% (perc, BCC)]+data['%d_TNFM_%s'% (perc, BCD)])
        data['%d_TNFM_%s'% (perc, EF)]= (data['%d_TNFM_%s'% (perc, BSA)]+data['%d_TNFM_%s'% (perc, BSB)])
        data['%d_TNFM_%s'% (perc, EG)]= (data['%d_TNFM_%s'% (perc, EF)]/data['%d_TNFM_%s'% (perc, EA)]*100)
        
        data['%d_ONFM_%s'% (perc, EA)]= (data['%d_ONFM_%s'% (perc, BSD)]+data['%d_ONFM_%s'% (perc, BSE)]+data['%d_ONFM_%s'% (perc, BSF)])
        data['%d_ONFM_%s'% (perc, EB)]= (data['%d_ONFM_%s'% (perc, BSB)]/data['%d_ONFM_%s'% (perc, EA)]*100)
        data['%d_ONFM_%s'% (perc, EC)]= (data['%d_ONFM_%s'% (perc, BSG)]+data['%d_ONFM_%s'% (perc, BSH)]+data['%d_ONFM_%s'% (perc, BSI)])
        data['%d_ONFM_%s'% (perc, EE)]= (data['%d_ONFM_%s'% (perc, BCA)]+data['%d_ONFM_%s'% (perc, BCB)]+data['%d_ONFM_%s'% (perc, BCC)]+data['%d_ONFM_%s'% (perc, BCD)])
        data['%d_ONFM_%s'% (perc, EF)]= (data['%d_ONFM_%s'% (perc, BSA)]+data['%d_ONFM_%s'% (perc, BSB)])
        data['%d_ONFM_%s'% (perc, EG)]= (data['%d_ONFM_%s'% (perc, EF)]/data['%d_ONFM_%s'% (perc, EA)]*100)
        
        data['%d_BNFM_%s'% (perc, EA)]= (data['%d_BNFM_%s'% (perc, BSD)]+data['%d_BNFM_%s'% (perc, BSE)]+data['%d_BNFM_%s'% (perc, BSF)])
        data['%d_BNFM_%s'% (perc, EB)]= (data['%d_BNFM_%s'% (perc, BSB)]/data['%d_BNFM_%s'% (perc, EA)]*100)
        data['%d_BNFM_%s'% (perc, EC)]= (data['%d_BNFM_%s'% (perc, BSG)]+data['%d_BNFM_%s'% (perc, BSH)]+data['%d_BNFM_%s'% (perc, BSI)])
        data['%d_BNFM_%s'% (perc, EE)]= (data['%d_BNFM_%s'% (perc, BCA)]+data['%d_BNFM_%s'% (perc, BCB)]+data['%d_BNFM_%s'% (perc, BCC)]+data['%d_BNFM_%s'% (perc, BCD)])
        data['%d_BNFM_%s'% (perc, EF)]= (data['%d_BNFM_%s'% (perc, BSA)]+data['%d_BNFM_%s'% (perc, BSB)])
        data['%d_BNFM_%s'% (perc, EG)]= (data['%d_BNFM_%s'% (perc, EF)]/data['%d_BNFM_%s'% (perc, EA)]*100)
        
        data['%d_TNCM_%s'% (perc, EA)]= (data['%d_TNCM_%s'% (perc, BSD)]+data['%d_TNCM_%s'% (perc, BSE)]+data['%d_TNCM_%s'% (perc, BSF)])
        data['%d_TNCM_%s'% (perc, EB)]= (data['%d_TNCM_%s'% (perc, BSB)]/data['%d_TNCM_%s'% (perc, EA)]*100)
        data['%d_TNCM_%s'% (perc, EC)]= (data['%d_TNCM_%s'% (perc, BSG)]+data['%d_TNCM_%s'% (perc, BSH)]+data['%d_TNCM_%s'% (perc, BSI)])
        data['%d_TNCM_%s'% (perc, EE)]= (data['%d_TNCM_%s'% (perc, BCA)]+data['%d_TNCM_%s'% (perc, BCB)]+data['%d_TNCM_%s'% (perc, BCC)]+data['%d_TNCM_%s'% (perc, BCD)])
        data['%d_TNCM_%s'% (perc, EF)]= (data['%d_TNCM_%s'% (perc, BSA)]+data['%d_TNCM_%s'% (perc, BSB)])
        data['%d_TNCM_%s'% (perc, EG)]= (data['%d_TNCM_%s'% (perc, EF)]/data['%d_TNCM_%s'% (perc, EA)]*100)
        
        data['%d_ONCM_%s'% (perc, EA)]= (data['%d_ONCM_%s'% (perc, BSD)]+data['%d_ONCM_%s'% (perc, BSE)]+data['%d_ONCM_%s'% (perc, BSF)])
        data['%d_ONCM_%s'% (perc, EB)]= (data['%d_ONCM_%s'% (perc, BSB)]/data['%d_ONCM_%s'% (perc, EA)]*100)
        data['%d_ONCM_%s'% (perc, EC)]= (data['%d_ONCM_%s'% (perc, BSG)]+data['%d_ONCM_%s'% (perc, BSH)]+data['%d_ONCM_%s'% (perc, BSI)])
        data['%d_ONCM_%s'% (perc, EE)]= (data['%d_ONCM_%s'% (perc, BCA)]+data['%d_ONCM_%s'% (perc, BCB)]+data['%d_ONCM_%s'% (perc, BCC)]+data['%d_ONCM_%s'% (perc, BCD)])
        data['%d_ONCM_%s'% (perc, EF)]= (data['%d_ONCM_%s'% (perc, BSA)]+data['%d_ONCM_%s'% (perc, BSB)])
        data['%d_ONCM_%s'% (perc, EG)]= (data['%d_ONCM_%s'% (perc, EF)]/data['%d_ONCM_%s'% (perc, EA)]*100)
        
        data['%d_BNCM_%s'% (perc, EA)]= (data['%d_BNCM_%s'% (perc, BSD)]+data['%d_BNCM_%s'% (perc, BSE)]+data['%d_BNCM_%s'% (perc, BSF)])
        data['%d_BNCM_%s'% (perc, EB)]= (data['%d_BNCM_%s'% (perc, BSB)]/data['%d_BNCM_%s'% (perc, EA)]*100)
        data['%d_BNCM_%s'% (perc, EC)]= (data['%d_BNCM_%s'% (perc, BSG)]+data['%d_BNCM_%s'% (perc, BSH)]+data['%d_BNCM_%s'% (perc, BSI)])
        data['%d_BNCM_%s'% (perc, EE)]= (data['%d_BNCM_%s'% (perc, BCA)]+data['%d_BNCM_%s'% (perc, BCB)]+data['%d_BNCM_%s'% (perc, BCC)]+data['%d_BNCM_%s'% (perc, BCD)])
        data['%d_BNCM_%s'% (perc, EF)]= (data['%d_BNCM_%s'% (perc, BSA)]+data['%d_BNCM_%s'% (perc, BSB)])
        data['%d_BNCM_%s'% (perc, EG)]= (data['%d_BNCM_%s'% (perc, EF)]/data['%d_BNCM_%s'% (perc, EA)]*100)
    ...
    for position, col_name in enumerate(list_behaviors_social):
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_TNCR_%s'% (perc, col_name)]=(data['%d_TNCF_%s'% (perc, col_name)]+data['%d_TNCM_%s'% (perc, col_name)])
            data['%d_TNFR_%s'% (perc, col_name)]=(data['%d_TNFF_%s'% (perc, col_name)]+data['%d_TNFM_%s'% (perc, col_name)])
    
    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_TNCR_%s'% (perc, EA)]=(data['%d_TNCF_%s'% (perc, EA)]+data['%d_TNCM_%s'% (perc, EA)])
        data['%d_TNFR_%s'% (perc, EA)]=(data['%d_TNFF_%s'% (perc, EA)]+data['%d_TNFM_%s'% (perc, EA)])
        data['%d_TNCR_%s'% (perc, EB)]=(data['%d_TNCF_%s'% (perc, EB)]+data['%d_TNCM_%s'% (perc, EB)])
        data['%d_TNFR_%s'% (perc, EB)]=(data['%d_TNFF_%s'% (perc, EB)]+data['%d_TNFM_%s'% (perc, EB)])
        data['%d_TNCR_%s'% (perc, EC)]=(data['%d_TNCF_%s'% (perc, EC)]+data['%d_TNCM_%s'% (perc, EC)])
        data['%d_TNFR_%s'% (perc, EC)]=(data['%d_TNFF_%s'% (perc, EC)]+data['%d_TNFM_%s'% (perc, EC)])
        data['%d_TNCR_%s'% (perc, EE)]=(data['%d_TNCF_%s'% (perc, EE)]+data['%d_TNCM_%s'% (perc, EE)])
        data['%d_TNFR_%s'% (perc, EE)]=(data['%d_TNFF_%s'% (perc, EE)]+data['%d_TNFM_%s'% (perc, EE)])
        data['%d_TNCR_%s'% (perc, EF)]=(data['%d_TNCF_%s'% (perc, EF)]+data['%d_TNCM_%s'% (perc, EF)])
        data['%d_TNFR_%s'% (perc, EF)]=(data['%d_TNFF_%s'% (perc, EF)]+data['%d_TNFM_%s'% (perc, EF)])
        data['%d_TNCR_%s'% (perc, EG)]=(data['%d_TNCF_%s'% (perc, EG)]+data['%d_TNCM_%s'% (perc, EG)])
        data['%d_TNFR_%s'% (perc, EG)]=(data['%d_TNFF_%s'% (perc, EG)]+data['%d_TNFM_%s'% (perc, EG)])
    ...
    for position, col_name in enumerate(list_behaviors_social):
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_TNM_%s'% (perc, col_name)]=(data['%d_TNCM_%s'% (perc, col_name)]+data['%d_TNFM_%s'% (perc, col_name)])
            data['%d_TNF_%s'% (perc, col_name)]=(data['%d_TNFF_%s'% (perc, col_name)]+data['%d_TNCF_%s'% (perc, col_name)])

    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_TNM_%s'% (perc, EA)]=(data['%d_TNCM_%s'% (perc, EA)]+data['%d_TNFM_%s'% (perc, EA)])
        data['%d_TNF_%s'% (perc, EA)]=(data['%d_TNFF_%s'% (perc, EA)]+data['%d_TNCF_%s'% (perc, EA)])
        data['%d_TNM_%s'% (perc, EB)]=(data['%d_TNCM_%s'% (perc, EB)]+data['%d_TNFM_%s'% (perc, EB)])
        data['%d_TNF_%s'% (perc, EB)]=(data['%d_TNFF_%s'% (perc, EB)]+data['%d_TNCF_%s'% (perc, EB)])
        data['%d_TNM_%s'% (perc, EC)]=(data['%d_TNCM_%s'% (perc, EC)]+data['%d_TNFM_%s'% (perc, EC)])
        data['%d_TNF_%s'% (perc, EC)]=(data['%d_TNFF_%s'% (perc, EC)]+data['%d_TNCF_%s'% (perc, EC)])
        data['%d_TNM_%s'% (perc, EE)]=(data['%d_TNCM_%s'% (perc, EE)]+data['%d_TNFM_%s'% (perc, EE)])
        data['%d_TNF_%s'% (perc, EE)]=(data['%d_TNFF_%s'% (perc, EE)]+data['%d_TNCF_%s'% (perc, EE)])
        data['%d_TNM_%s'% (perc, EF)]=(data['%d_TNCM_%s'% (perc, EF)]+data['%d_TNFM_%s'% (perc, EF)])
        data['%d_TNF_%s'% (perc, EF)]=(data['%d_TNFF_%s'% (perc, EF)]+data['%d_TNCF_%s'% (perc, EF)])
        data['%d_TNM_%s'% (perc, EG)]=(data['%d_TNCM_%s'% (perc, EG)]+data['%d_TNFM_%s'% (perc, EG)])
        data['%d_TNF_%s'% (perc, EG)]=(data['%d_TNFF_%s'% (perc, EG)]+data['%d_TNCF_%s'% (perc, EG)])
    ...
    for position, col_name in enumerate(list_behaviors_social):    
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_BNCR_%s'% (perc, col_name)]=(data['%d_BNCF_%s'% (perc, col_name)]+data['%d_BNCM_%s'% (perc, col_name)])
            data['%d_BNFR_%s'% (perc, col_name)]=(data['%d_BNFF_%s'% (perc, col_name)]+data['%d_BNFM_%s'% (perc, col_name)])

    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_BNCR_%s'% (perc, EA)]=(data['%d_BNCF_%s'% (perc, EA)]+data['%d_BNCM_%s'% (perc, EA)])
        data['%d_BNFR_%s'% (perc, EA)]=(data['%d_BNFF_%s'% (perc, EA)]+data['%d_BNFM_%s'% (perc, EA)])
        data['%d_BNCR_%s'% (perc, EB)]=(data['%d_BNCF_%s'% (perc, EB)]+data['%d_BNCM_%s'% (perc, EB)])
        data['%d_BNFR_%s'% (perc, EB)]=(data['%d_BNFF_%s'% (perc, EB)]+data['%d_BNFM_%s'% (perc, EB)])
        data['%d_BNCR_%s'% (perc, EC)]=(data['%d_BNCF_%s'% (perc, EC)]+data['%d_BNCM_%s'% (perc, EC)])
        data['%d_BNFR_%s'% (perc, EC)]=(data['%d_BNFF_%s'% (perc, EC)]+data['%d_BNFM_%s'% (perc, EC)])
        data['%d_BNCR_%s'% (perc, EE)]=(data['%d_BNCF_%s'% (perc, EE)]+data['%d_BNCM_%s'% (perc, EE)])
        data['%d_BNFR_%s'% (perc, EE)]=(data['%d_BNFF_%s'% (perc, EE)]+data['%d_BNFM_%s'% (perc, EE)])
        data['%d_BNCR_%s'% (perc, EF)]=(data['%d_BNCF_%s'% (perc, EF)]+data['%d_BNCM_%s'% (perc, EF)])
        data['%d_BNFR_%s'% (perc, EF)]=(data['%d_BNFF_%s'% (perc, EF)]+data['%d_BNFM_%s'% (perc, EF)])
        data['%d_BNCR_%s'% (perc, EG)]=(data['%d_BNCF_%s'% (perc, EG)]+data['%d_BNCM_%s'% (perc, EG)])
        data['%d_BNFR_%s'% (perc, EG)]=(data['%d_BNFF_%s'% (perc, EG)]+data['%d_BNFM_%s'% (perc, EG)])
    ...
    for position, col_name in enumerate(list_behaviors_social): 
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_BNM_%s'% (perc, col_name)]=(data['%d_BNCM_%s'% (perc, col_name)]+data['%d_BNFM_%s'% (perc, col_name)])
            data['%d_BNF_%s'% (perc, col_name)]=(data['%d_BNFF_%s'% (perc, col_name)]+data['%d_BNCF_%s'% (perc, col_name)])

    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_BNM_%s'% (perc, EA)]=(data['%d_BNCM_%s'% (perc, EA)]+data['%d_BNFM_%s'% (perc, EA)])
        data['%d_BNF_%s'% (perc, EA)]=(data['%d_BNFF_%s'% (perc, EA)]+data['%d_BNCF_%s'% (perc, EA)])
        data['%d_BNM_%s'% (perc, EB)]=(data['%d_BNCM_%s'% (perc, EB)]+data['%d_BNFM_%s'% (perc, EB)])
        data['%d_BNF_%s'% (perc, EB)]=(data['%d_BNFF_%s'% (perc, EB)]+data['%d_BNCF_%s'% (perc, EB)])
        data['%d_BNM_%s'% (perc, EC)]=(data['%d_BNCM_%s'% (perc, EC)]+data['%d_BNFM_%s'% (perc, EC)])
        data['%d_BNF_%s'% (perc, EC)]=(data['%d_BNFF_%s'% (perc, EC)]+data['%d_BNCF_%s'% (perc, EC)])
        data['%d_BNM_%s'% (perc, EE)]=(data['%d_BNCM_%s'% (perc, EE)]+data['%d_BNFM_%s'% (perc, EE)])
        data['%d_BNF_%s'% (perc, EE)]=(data['%d_BNFF_%s'% (perc, EE)]+data['%d_BNCF_%s'% (perc, EE)])
        data['%d_BNM_%s'% (perc, EF)]=(data['%d_BNCM_%s'% (perc, EF)]+data['%d_BNFM_%s'% (perc, EF)])
        data['%d_BNF_%s'% (perc, EF)]=(data['%d_BNFF_%s'% (perc, EF)]+data['%d_BNCF_%s'% (perc, EF)])
        data['%d_BNM_%s'% (perc, EG)]=(data['%d_BNCM_%s'% (perc, EG)]+data['%d_BNFM_%s'% (perc, EG)])
        data['%d_BNF_%s'% (perc, EG)]=(data['%d_BNFF_%s'% (perc, EG)]+data['%d_BNCF_%s'% (perc, EG)])
    ...
    for position, col_name in enumerate(list_behaviors_social): 
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_ONCR_%s'% (perc, col_name)]=(data['%d_ONCF_%s'% (perc, col_name)]+data['%d_ONCM_%s'% (perc, col_name)])
            data['%d_ONFR_%s'% (perc, col_name)]=(data['%d_ONFF_%s'% (perc, col_name)]+data['%d_ONFM_%s'% (perc, col_name)])

    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_ONCR_%s'% (perc, EA)]=(data['%d_ONCF_%s'% (perc, EA)]+data['%d_ONCM_%s'% (perc, EA)])
        data['%d_ONFR_%s'% (perc, EA)]=(data['%d_ONFF_%s'% (perc, EA)]+data['%d_ONFM_%s'% (perc, EA)])
        data['%d_ONCR_%s'% (perc, EB)]=(data['%d_ONCF_%s'% (perc, EB)]+data['%d_ONCM_%s'% (perc, EB)])
        data['%d_ONFR_%s'% (perc, EB)]=(data['%d_ONFF_%s'% (perc, EB)]+data['%d_ONFM_%s'% (perc, EB)])
        data['%d_ONCR_%s'% (perc, EC)]=(data['%d_ONCF_%s'% (perc, EC)]+data['%d_ONCM_%s'% (perc, EC)])
        data['%d_ONFR_%s'% (perc, EC)]=(data['%d_ONFF_%s'% (perc, EC)]+data['%d_ONFM_%s'% (perc, EC)])
        data['%d_ONCR_%s'% (perc, EE)]=(data['%d_ONCF_%s'% (perc, EE)]+data['%d_ONCM_%s'% (perc, EE)])
        data['%d_ONFR_%s'% (perc, EE)]=(data['%d_ONFF_%s'% (perc, EE)]+data['%d_ONFM_%s'% (perc, EE)])
        data['%d_ONCR_%s'% (perc, EF)]=(data['%d_ONCF_%s'% (perc, EF)]+data['%d_ONCM_%s'% (perc, EF)])
        data['%d_ONFR_%s'% (perc, EF)]=(data['%d_ONFF_%s'% (perc, EF)]+data['%d_ONFM_%s'% (perc, EF)])
        data['%d_ONCR_%s'% (perc, EG)]=(data['%d_ONCF_%s'% (perc, EG)]+data['%d_ONCM_%s'% (perc, EG)])
        data['%d_ONFR_%s'% (perc, EG)]=(data['%d_ONFF_%s'% (perc, EG)]+data['%d_ONFM_%s'% (perc, EG)])
    ...
    for position, col_name in enumerate(list_behaviors_social): 
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_ONM_%s'% (perc, col_name)]=(data['%d_ONCM_%s'% (perc, col_name)]+data['%d_ONFM_%s'% (perc, col_name)])
            data['%d_ONF_%s'% (perc, col_name)]=(data['%d_ONFF_%s'% (perc, col_name)]+data['%d_ONCF_%s'% (perc, col_name)])

    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_ONM_%s'% (perc, EA)]=(data['%d_ONCM_%s'% (perc, EA)]+data['%d_ONFM_%s'% (perc, EA)])
        data['%d_ONF_%s'% (perc, EA)]=(data['%d_ONFF_%s'% (perc, EA)]+data['%d_ONCF_%s'% (perc, EA)])
        data['%d_ONM_%s'% (perc, EB)]=(data['%d_ONCM_%s'% (perc, EB)]+data['%d_ONFM_%s'% (perc, EB)])
        data['%d_ONF_%s'% (perc, EB)]=(data['%d_ONFF_%s'% (perc, EB)]+data['%d_ONCF_%s'% (perc, EB)])
        data['%d_ONM_%s'% (perc, EC)]=(data['%d_ONCM_%s'% (perc, EC)]+data['%d_ONFM_%s'% (perc, EC)])
        data['%d_ONF_%s'% (perc, EC)]=(data['%d_ONFF_%s'% (perc, EC)]+data['%d_ONCF_%s'% (perc, EC)])
        data['%d_ONM_%s'% (perc, EE)]=(data['%d_ONCM_%s'% (perc, EE)]+data['%d_ONFM_%s'% (perc, EE)])
        data['%d_ONF_%s'% (perc, EE)]=(data['%d_ONFF_%s'% (perc, EE)]+data['%d_ONCF_%s'% (perc, EE)])
        data['%d_ONM_%s'% (perc, EF)]=(data['%d_ONCM_%s'% (perc, EF)]+data['%d_ONFM_%s'% (perc, EF)])
        data['%d_ONF_%s'% (perc, EF)]=(data['%d_ONFF_%s'% (perc, EF)]+data['%d_ONCF_%s'% (perc, EF)])
        data['%d_ONM_%s'% (perc, EG)]=(data['%d_ONCM_%s'% (perc, EG)]+data['%d_ONFM_%s'% (perc, EG)])
        data['%d_ONF_%s'% (perc, EG)]=(data['%d_ONFF_%s'% (perc, EG)]+data['%d_ONCF_%s'% (perc, EG)])
...
## now save the data frame to excel
data_full.to_csv("HN003 raw data full_perc_mod_freq.csv")
data_all.to_csv("HN003 raw data all_perc_mod_freq.csv")
data_CB1.to_csv("HN003 raw data CB1_perc_mod_freq.csv")
data_CB2.to_csv("HN003 raw data CB2_perc_mod_freq.csv")
data_CB3.to_csv("HN003 raw data CB3_perc_mod_freq.csv")
data_CB4.to_csv("HN003 raw data CB4_perc_mod_freq.csv")
data_CB5.to_csv("HN003 raw data CB5_perc_mod_freq.csv")
data_CB6.to_csv("HN003 raw data CB6_perc_mod_freq.csv")
...
list_df_results=[results_all_TN_mod,results_all_ON_mod,results_all_BN_mod,
                 results_CB1_TN_mod,results_CB1_ON_mod,results_CB1_BN_mod,
                 results_CB2_TN_mod,results_CB2_ON_mod,results_CB2_BN_mod,
                 results_CB3_TN_mod,results_CB3_ON_mod,results_CB3_BN_mod,
                 results_CB4_TN_mod,results_CB4_ON_mod,results_CB4_BN_mod,
                 results_CB5_TN_mod,results_CB5_ON_mod,results_CB5_BN_mod,
                 results_CB6_TN_mod,results_CB6_ON_mod,results_CB6_BN_mod,
                 results_MAB_TN_mod,results_MAB_ON_mod,results_MAB_BN_mod,
                 results_all_TN_modtreat,results_all_ON_modtreat,results_all_BN_modtreat,
                 results_CB1_TN_modtreat,results_CB1_ON_modtreat,results_CB1_BN_modtreat,
                 results_CB2_TN_modtreat,results_CB2_ON_modtreat,results_CB2_BN_modtreat,
                 results_CB3_TN_modtreat,results_CB3_ON_modtreat,results_CB3_BN_modtreat,
                 results_CB4_TN_modtreat,results_CB4_ON_modtreat,results_CB4_BN_modtreat,
                 results_CB5_TN_modtreat,results_CB5_ON_modtreat,results_CB5_BN_modtreat,
                 results_CB6_TN_modtreat,results_CB6_ON_modtreat,results_CB6_BN_modtreat,
                 results_MAB_TN_modtreat,results_MAB_ON_modtreat,results_MAB_BN_modtreat]
...
list_mean_titles=['mean_all_TN_mod','mean_all_ON_mod','mean_all_BN_mod',
                 'mean_CB1_TN_mod','mean_CB1_ON_mod','mean_CB1_BN_mod',
                 'mean_CB2_TN_mod','mean_CB2_ON_mod','mean_CB2_BN_mod',
                 'mean_CB3_TN_mod','mean_CB3_ON_mod','mean_CB3_BN_mod',
                 'mean_CB4_TN_mod','mean_CB4_ON_mod','mean_CB4_BN_mod',
                 'mean_CB5_TN_mod','mean_CB5_ON_mod','mean_CB5_BN_mod',
                 'mean_CB6_TN_mod','mean_CB6_ON_mod','mean_CB6_BN_mod',
                 'mean_MAB_TN_mod','mean_MAB_ON_mod','mean_MAB_BN_mod',
                 'mean_all_TN_modtreat','mean_all_ON_modtreat','mean_all_BN_modtreat',
                 'mean_CB1_TN_modtreat','mean_CB1_ON_modtreat','mean_CB1_BN_modtreat',
                 'mean_CB2_TN_modtreat','mean_CB2_ON_modtreat','mean_CB2_BN_modtreat',
                 'mean_CB3_TN_modtreat','mean_CB3_ON_modtreat','mean_CB3_BN_modtreat',
                 'mean_CB4_TN_modtreat','mean_CB4_ON_modtreat','mean_CB4_BN_modtreat',
                 'mean_CB5_TN_modtreat','mean_CB5_ON_modtreat','mean_CB5_BN_modtreat',
                 'mean_CB6_TN_modtreat','mean_CB6_ON_modtreat','mean_CB6_BN_modtreat',
                 'mean_MAB_TN_modtreat','mean_MAB_ON_modtreat','mean_MAB_BN_modtreat']
...
list_df_results_mod= list_df_results[:24]
list_df_results_modtreat= list_df_results[24:48]
...
list_results_mod= list_results_titles[:24]
list_results_modtreat= list_results_titles[24:48]
