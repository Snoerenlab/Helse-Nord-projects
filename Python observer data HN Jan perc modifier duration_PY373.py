...
for dt, dataframe in enumerate(df_CB): 
    ...
    for position, col_name in enumerate(list_behaviors_social): 
        ...
        for rank, perc in enumerate(list_intervals):
            data['%d_TDFF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_TDFF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_TDFF_%s'% (perc, col_name)]) 
            data['%d_TDFF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_treat_num_back']==1)&(data[MODTREAT]=='FLX-females')&(data['interval']==perc)),
                data['obs_beh_int_treat_sumdur'], data['%d_TDFF_%s'% (perc, col_name)]) 
            data['%d_TDFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_TDFF_%s'% (perc, col_name)]=np.where(data['%d_TDFF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_TDFF_%s'% (perc, col_name)])
            data['%d_TDFF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_TDFF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_TDFF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_TDFF_%s'% (perc, col_name)])
            data['%d_TDFF_%s'% (perc, col_name)]=np.where(data['%d_TDFF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_TDFF_%s'% (perc, col_name)])
            data['%d_TDFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_TDFF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_TDFF_%s'% (perc, col_name)])
            
                # Calculate total duration of each "social" behavior directed at CTR-females in total environment
            data['%d_TDCF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_TDCF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_TDCF_%s'% (perc, col_name)]) 
            data['%d_TDCF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_treat_num_back']==1)&(data[MODTREAT]=='CTR-females')&(data['interval']==perc)),
                data['obs_beh_int_treat_sumdur'], data['%d_TDCF_%s'% (perc, col_name)]) 
            data['%d_TDCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_TDCF_%s'% (perc, col_name)]=np.where(data['%d_TDCF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_TDCF_%s'% (perc, col_name)])
            data['%d_TDCF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_TDCF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_TDCF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_TDCF_%s'% (perc, col_name)])
            data['%d_TDCF_%s'% (perc, col_name)]=np.where(data['%d_TDCF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_TDCF_%s'% (perc, col_name)])
            data['%d_TDCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_TDCF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_TDCF_%s'% (perc, col_name)])
            
            # Calculate total duration of each "social" behavior directed at FLX-male in total environment
            data['%d_TDFM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_TDFM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_TDFM_%s'% (perc, col_name)]) 
            data['%d_TDFM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_treat_num_back']==1)&(data[MODTREAT]=='FLX-males')&(data['interval']==perc)),
                data['obs_beh_int_treat_sumdur'], data['%d_TDFM_%s'% (perc, col_name)]) 
            data['%d_TDFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_TDFM_%s'% (perc, col_name)]=np.where(data['%d_TDFM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_TDFM_%s'% (perc, col_name)])
            data['%d_TDFM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_TDFM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_TDFM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_TDFM_%s'% (perc, col_name)])
            data['%d_TDFM_%s'% (perc, col_name)]=np.where(data['%d_TDFM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_TDFM_%s'% (perc, col_name)])
            data['%d_TDFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_TDFM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_TDFM_%s'% (perc, col_name)])
            
                # Calculate total duration of each "social" behavior directed at CTR-males in total environment
            data['%d_TDCM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_TDCM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_TDCM_%s'% (perc, col_name)]) 
            data['%d_TDCM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_treat_num_back']==1)&(data[MODTREAT]=='CTR-males')&(data['interval']==perc)),
                data['obs_beh_int_treat_sumdur'], data['%d_TDCM_%s'% (perc, col_name)]) 
            data['%d_TDCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_TDCM_%s'% (perc, col_name)]=np.where(data['%d_TDCM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_TDCM_%s'% (perc, col_name)])
            data['%d_TDCM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_TDCM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_TDCM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_TDCM_%s'% (perc, col_name)])
            data['%d_TDCM_%s'% (perc, col_name)]=np.where(data['%d_TDCM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_TDCM_%s'% (perc, col_name)])
            data['%d_TDCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_TDCM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_TDCM_%s'% (perc, col_name)])
        
            # Calculate total duration of each "social" behavior directed at FLX-female in burrow
            data['%d_BDFF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_BDFF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_BDFF_%s'% (perc, col_name)]) 
            data['%d_BDFF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num_back']==1)&(data[MODTREAT]=='FLX-females')&(data[MODLOC]=='Burrow')&(data['interval']==perc)),
                data['obs_beh_int_loc_treat_sumdur'], data['%d_BDFF_%s'% (perc, col_name)]) 
            data['%d_BDFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_BDFF_%s'% (perc, col_name)]=np.where(data['%d_BDFF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_BDFF_%s'% (perc, col_name)])
            data['%d_BDFF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_BDFF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_BDFF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_BDFF_%s'% (perc, col_name)])
            data['%d_BDFF_%s'% (perc, col_name)]=np.where(data['%d_BDFF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_BDFF_%s'% (perc, col_name)])
            data['%d_BDFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_BDFF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_BDFF_%s'% (perc, col_name)])
            
                # Calculate total duration of each "social" behavior directed at CTR-females in burrow
            data['%d_BDCF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_BDCF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_BDCF_%s'% (perc, col_name)]) 
            data['%d_BDCF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num_back']==1)&(data[MODTREAT]=='CTR-females')&(data[MODLOC]=='Burrow')&(data['interval']==perc)),
                data['obs_beh_int_loc_treat_sumdur'], data['%d_BDCF_%s'% (perc, col_name)]) 
            data['%d_BDCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_BDCF_%s'% (perc, col_name)]=np.where(data['%d_BDCF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_BDCF_%s'% (perc, col_name)])
            data['%d_BDCF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_BDCF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_BDCF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_BDCF_%s'% (perc, col_name)])
            data['%d_BDCF_%s'% (perc, col_name)]=np.where(data['%d_BDCF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_BDCF_%s'% (perc, col_name)])
            data['%d_BDCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_BDCF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_BDCF_%s'% (perc, col_name)])
            
            # Calculate total duration of each "social" behavior directed at FLX-male in burrow
            data['%d_BDFM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_BDFM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_BDFM_%s'% (perc, col_name)]) 
            data['%d_BDFM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num_back']==1)&(data[MODTREAT]=='FLX-males')&(data[MODLOC]=='Burrow')&(data['interval']==perc)),
                data['obs_beh_int_loc_treat_sumdur'], data['%d_BDFM_%s'% (perc, col_name)]) 
            data['%d_BDFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_BDFM_%s'% (perc, col_name)]=np.where(data['%d_BDFM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_BDFM_%s'% (perc, col_name)])
            data['%d_BDFM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_BDFM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_BDFM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_BDFM_%s'% (perc, col_name)])
            data['%d_BDFM_%s'% (perc, col_name)]=np.where(data['%d_BDFM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_BDFM_%s'% (perc, col_name)])
            data['%d_BDFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_BDFM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_BDFM_%s'% (perc, col_name)])
            
                # Calculate total duration of each "social" behavior directed at CTR-males in burrow
            data['%d_BDCM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_BDCM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_BDCM_%s'% (perc, col_name)]) 
            data['%d_BDCM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num_back']==1)&(data[MODTREAT]=='CTR-males')&(data[MODLOC]=='Burrow')&(data['interval']==perc)),
                data['obs_beh_int_loc_treat_sumdur'], data['%d_BDCM_%s'% (perc, col_name)]) 
            data['%d_BDCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_BDCM_%s'% (perc, col_name)]=np.where(data['%d_BDCM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_BDCM_%s'% (perc, col_name)])
            data['%d_BDCM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_BDCM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_BDCM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_BDCM_%s'% (perc, col_name)])
            data['%d_BDCM_%s'% (perc, col_name)]=np.where(data['%d_BDCM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_BDCM_%s'% (perc, col_name)])
            data['%d_BDCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_BDCM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_BDCM_%s'% (perc, col_name)])
        
            # Calculate total duration of each "social" behavior directed at FLX-female in open field
            data['%d_ODFF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_ODFF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_ODFF_%s'% (perc, col_name)]) 
            data['%d_ODFF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num_back']==1)&(data[MODTREAT]=='FLX-females')&(data[MODLOC]=='Open field')&(data['interval']==perc)),
                data['obs_beh_int_loc_treat_sumdur'], data['%d_ODFF_%s'% (perc, col_name)]) 
            data['%d_ODFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_ODFF_%s'% (perc, col_name)]=np.where(data['%d_ODFF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_ODFF_%s'% (perc, col_name)])
            data['%d_ODFF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_ODFF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_ODFF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_ODFF_%s'% (perc, col_name)])
            data['%d_ODFF_%s'% (perc, col_name)]=np.where(data['%d_ODFF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_ODFF_%s'% (perc, col_name)])
            data['%d_ODFF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_ODFF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_ODFF_%s'% (perc, col_name)])
            
                # Calculate total duration of each "social" behavior directed at CTR-females in open field
            data['%d_ODCF_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_ODCF_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_ODCF_%s'% (perc, col_name)]) 
            data['%d_ODCF_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num_back']==1)&(data[MODTREAT]=='CTR-females')&(data[MODLOC]=='Open field')&(data['interval']==perc)),
                data['obs_beh_int_loc_treat_sumdur'], data['%d_ODCF_%s'% (perc, col_name)]) 
            data['%d_ODCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_ODCF_%s'% (perc, col_name)]=np.where(data['%d_ODCF_%s'% (perc, col_name)]==99999, np.NaN, data['%d_ODCF_%s'% (perc, col_name)])
            data['%d_ODCF_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_ODCF_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_ODCF_%s'% (perc, col_name)]==88888)), 
                0,data['%d_ODCF_%s'% (perc, col_name)])
            data['%d_ODCF_%s'% (perc, col_name)]=np.where(data['%d_ODCF_%s'% (perc, col_name)]==88888, np.NaN, data['%d_ODCF_%s'% (perc, col_name)])
            data['%d_ODCF_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_ODCF_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_ODCF_%s'% (perc, col_name)])
            
            # Calculate total duration of each "social" behavior directed at FLX-male in open field
            data['%d_ODFM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_ODFM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_ODFM_%s'% (perc, col_name)]) 
            data['%d_ODFM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num_back']==1)&(data[MODTREAT]=='FLX-males')&(data[MODLOC]=='Open field')&(data['interval']==perc)),
                data['obs_beh_int_loc_treat_sumdur'], data['%d_ODFM_%s'% (perc, col_name)]) 
            data['%d_ODFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_ODFM_%s'% (perc, col_name)]=np.where(data['%d_ODFM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_ODFM_%s'% (perc, col_name)])
            data['%d_ODFM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_ODFM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_ODFM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_ODFM_%s'% (perc, col_name)])
            data['%d_ODFM_%s'% (perc, col_name)]=np.where(data['%d_ODFM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_ODFM_%s'% (perc, col_name)])
            data['%d_ODFM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_ODFM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_ODFM_%s'% (perc, col_name)])
            
                # Calculate total duration of each "social" behavior directed at CTR-males in open field
            data['%d_ODCM_%s'% (perc, col_name)]= np.where(data['obs_num']==1,99999, np.NaN) 
            data['%d_ODCM_%s'% (perc, col_name)]= np.where(data['obs_num_back']==1,88888, data['%d_ODCM_%s'% (perc, col_name)]) 
            data['%d_ODCM_%s'% (perc, col_name)]= np.where(((data[BEH]==col_name)&(data['obs_beh_int_loc_treat_num_back']==1)&(data[MODTREAT]=='CTR-males')&(data[MODLOC]=='Open field')&(data['interval']==perc)),
                data['obs_beh_int_loc_treat_sumdur'], data['%d_ODCM_%s'% (perc, col_name)]) 
            data['%d_ODCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)        
            data['%d_ODCM_%s'% (perc, col_name)]=np.where(data['%d_ODCM_%s'% (perc, col_name)]==99999, np.NaN, data['%d_ODCM_%s'% (perc, col_name)])
            data['%d_ODCM_%s'% (perc, col_name)].fillna(method = "backfill", inplace=True)
            data['%d_ODCM_%s'% (perc, col_name)]= np.where(((data['obs_num_back']!=1)&(data['%d_ODCM_%s'% (perc, col_name)]==88888)), 
                0,data['%d_ODCM_%s'% (perc, col_name)])
            data['%d_ODCM_%s'% (perc, col_name)]=np.where(data['%d_ODCM_%s'% (perc, col_name)]==88888, np.NaN, data['%d_ODCM_%s'% (perc, col_name)])
            data['%d_ODCM_%s'% (perc, col_name)].fillna(method = "ffill", inplace=True)
            data['%d_ODCM_%s'% (perc, col_name)]= np.where(data[BEH]=='None',0,data['%d_ODCM_%s'% (perc, col_name)])
    ...
    for rank, perc in enumerate(list_intervals):
        ...
        data['%d_TDFF_%s'% (perc, EA)]= (data['%d_TDFF_%s'% (perc, BSD)]+data['%d_TDFF_%s'% (perc, BSE)]+data['%d_TDFF_%s'% (perc, BSF)])
        data['%d_TDFF_%s'% (perc, EB)]= (data['%d_TDFF_%s'% (perc, BSB)]/data['%d_TDFF_%s'% (perc, EA)]*100)
        data['%d_TDFF_%s'% (perc, EC)]= (data['%d_TDFF_%s'% (perc, BSG)]+data['%d_TDFF_%s'% (perc, BSH)]+data['%d_TDFF_%s'% (perc, BSI)])
        data['%d_TDFF_%s'% (perc, EE)]= (data['%d_TDFF_%s'% (perc, BCA)]+data['%d_TDFF_%s'% (perc, BCB)]+data['%d_TDFF_%s'% (perc, BCC)]+data['%d_TDFF_%s'% (perc, BCD)])
        data['%d_TDFF_%s'% (perc, EF)]= (data['%d_TDFF_%s'% (perc, BSA)]+data['%d_TDFF_%s'% (perc, BSB)])
        data['%d_TDFF_%s'% (perc, EG)]= (data['%d_TDFF_%s'% (perc, EF)]/data['%d_TDFF_%s'% (perc, EA)]*100)
        
        data['%d_ODFF_%s'% (perc, EA)]= (data['%d_ODFF_%s'% (perc, BSD)]+data['%d_ODFF_%s'% (perc, BSE)]+data['%d_ODFF_%s'% (perc, BSF)])
        data['%d_ODFF_%s'% (perc, EB)]= (data['%d_ODFF_%s'% (perc, BSB)]/data['%d_ODFF_%s'% (perc, EA)]*100)
        data['%d_ODFF_%s'% (perc, EC)]= (data['%d_ODFF_%s'% (perc, BSG)]+data['%d_ODFF_%s'% (perc, BSH)]+data['%d_ODFF_%s'% (perc, BSI)])
        data['%d_ODFF_%s'% (perc, EE)]= (data['%d_ODFF_%s'% (perc, BCA)]+data['%d_ODFF_%s'% (perc, BCB)]+data['%d_ODFF_%s'% (perc, BCC)]+data['%d_ODFF_%s'% (perc, BCD)])
        data['%d_ODFF_%s'% (perc, EF)]= (data['%d_ODFF_%s'% (perc, BSA)]+data['%d_ODFF_%s'% (perc, BSB)])
        data['%d_ODFF_%s'% (perc, EG)]= (data['%d_ODFF_%s'% (perc, EF)]/data['%d_ODFF_%s'% (perc, EA)]*100)
        
        data['%d_BDFF_%s'% (perc, EA)]= (data['%d_BDFF_%s'% (perc, BSD)]+data['%d_BDFF_%s'% (perc, BSE)]+data['%d_BDFF_%s'% (perc, BSF)])
        data['%d_BDFF_%s'% (perc, EB)]= (data['%d_BDFF_%s'% (perc, BSB)]/data['%d_BDFF_%s'% (perc, EA)]*100)
        data['%d_BDFF_%s'% (perc, EC)]= (data['%d_BDFF_%s'% (perc, BSG)]+data['%d_BDFF_%s'% (perc, BSH)]+data['%d_BDFF_%s'% (perc, BSI)])
        data['%d_BDFF_%s'% (perc, EE)]= (data['%d_BDFF_%s'% (perc, BCA)]+data['%d_BDFF_%s'% (perc, BCB)]+data['%d_BDFF_%s'% (perc, BCC)]+data['%d_BDFF_%s'% (perc, BCD)])
        data['%d_BDFF_%s'% (perc, EF)]= (data['%d_BDFF_%s'% (perc, BSA)]+data['%d_BDFF_%s'% (perc, BSB)])
        data['%d_BDFF_%s'% (perc, EG)]= (data['%d_BDFF_%s'% (perc, EF)]/data['%d_BDFF_%s'% (perc, EA)]*100)
        
        data['%d_TDCF_%s'% (perc, EA)]= (data['%d_TDCF_%s'% (perc, BSD)]+data['%d_TDCF_%s'% (perc, BSE)]+data['%d_TDCF_%s'% (perc, BSF)])
        data['%d_TDCF_%s'% (perc, EB)]= (data['%d_TDCF_%s'% (perc, BSB)]/data['%d_TDCF_%s'% (perc, EA)]*100)
        data['%d_TDCF_%s'% (perc, EC)]= (data['%d_TDCF_%s'% (perc, BSG)]+data['%d_TDCF_%s'% (perc, BSH)]+data['%d_TDCF_%s'% (perc, BSI)])
        data['%d_TDCF_%s'% (perc, EE)]= (data['%d_TDCF_%s'% (perc, BCA)]+data['%d_TDCF_%s'% (perc, BCB)]+data['%d_TDCF_%s'% (perc, BCC)]+data['%d_TDCF_%s'% (perc, BCD)])
        data['%d_TDCF_%s'% (perc, EF)]= (data['%d_TDCF_%s'% (perc, BSA)]+data['%d_TDCF_%s'% (perc, BSB)])
        data['%d_TDCF_%s'% (perc, EG)]= (data['%d_TDCF_%s'% (perc, EF)]/data['%d_TDCF_%s'% (perc, EA)]*100)
        
        data['%d_ODCF_%s'% (perc, EA)]= (data['%d_ODCF_%s'% (perc, BSD)]+data['%d_ODCF_%s'% (perc, BSE)]+data['%d_ODCF_%s'% (perc, BSF)])
        data['%d_ODCF_%s'% (perc, EB)]= (data['%d_ODCF_%s'% (perc, BSB)]/data['%d_ODCF_%s'% (perc, EA)]*100)
        data['%d_ODCF_%s'% (perc, EC)]= (data['%d_ODCF_%s'% (perc, BSG)]+data['%d_ODCF_%s'% (perc, BSH)]+data['%d_ODCF_%s'% (perc, BSI)])
        data['%d_ODCF_%s'% (perc, EE)]= (data['%d_ODCF_%s'% (perc, BCA)]+data['%d_ODCF_%s'% (perc, BCB)]+data['%d_ODCF_%s'% (perc, BCC)]+data['%d_ODCF_%s'% (perc, BCD)])
        data['%d_ODCF_%s'% (perc, EF)]= (data['%d_ODCF_%s'% (perc, BSA)]+data['%d_ODCF_%s'% (perc, BSB)])
        data['%d_ODCF_%s'% (perc, EG)]= (data['%d_ODCF_%s'% (perc, EF)]/data['%d_ODCF_%s'% (perc, EA)]*100)
        
        data['%d_BDCF_%s'% (perc, EA)]= (data['%d_BDCF_%s'% (perc, BSD)]+data['%d_BDCF_%s'% (perc, BSE)]+data['%d_BDCF_%s'% (perc, BSF)])
        data['%d_BDCF_%s'% (perc, EB)]= (data['%d_BDCF_%s'% (perc, BSB)]/data['%d_BDCF_%s'% (perc, EA)]*100)
        data['%d_BDCF_%s'% (perc, EC)]= (data['%d_BDCF_%s'% (perc, BSG)]+data['%d_BDCF_%s'% (perc, BSH)]+data['%d_BDCF_%s'% (perc, BSI)])
        data['%d_BDCF_%s'% (perc, EE)]= (data['%d_BDCF_%s'% (perc, BCA)]+data['%d_BDCF_%s'% (perc, BCB)]+data['%d_BDCF_%s'% (perc, BCC)]+data['%d_BDCF_%s'% (perc, BCD)])
        data['%d_BDCF_%s'% (perc, EF)]= (data['%d_BDCF_%s'% (perc, BSA)]+data['%d_BDCF_%s'% (perc, BSB)])
        data['%d_BDCF_%s'% (perc, EG)]= (data['%d_BDCF_%s'% (perc, EF)]/data['%d_BDCF_%s'% (perc, EA)]*100)
        
        data['%d_TDFM_%s'% (perc, EA)]= (data['%d_TDFM_%s'% (perc, BSD)]+data['%d_TDFM_%s'% (perc, BSE)]+data['%d_TDFM_%s'% (perc, BSF)])
        data['%d_TDFM_%s'% (perc, EB)]= (data['%d_TDFM_%s'% (perc, BSB)]/data['%d_TDFM_%s'% (perc, EA)]*100)
        data['%d_TDFM_%s'% (perc, EC)]= (data['%d_TDFM_%s'% (perc, BSG)]+data['%d_TDFM_%s'% (perc, BSH)]+data['%d_TDFM_%s'% (perc, BSI)])
        data['%d_TDFM_%s'% (perc, EE)]= (data['%d_TDFM_%s'% (perc, BCA)]+data['%d_TDFM_%s'% (perc, BCB)]+data['%d_TDFM_%s'% (perc, BCC)]+data['%d_TDFM_%s'% (perc, BCD)])
        data['%d_TDFM_%s'% (perc, EF)]= (data['%d_TDFM_%s'% (perc, BSA)]+data['%d_TDFM_%s'% (perc, BSB)])
        data['%d_TDFM_%s'% (perc, EG)]= (data['%d_TDFM_%s'% (perc, EF)]/data['%d_TDFM_%s'% (perc, EA)]*100)
        
        data['%d_ODFM_%s'% (perc, EA)]= (data['%d_ODFM_%s'% (perc, BSD)]+data['%d_ODFM_%s'% (perc, BSE)]+data['%d_ODFM_%s'% (perc, BSF)])
        data['%d_ODFM_%s'% (perc, EB)]= (data['%d_ODFM_%s'% (perc, BSB)]/data['%d_ODFM_%s'% (perc, EA)]*100)
        data['%d_ODFM_%s'% (perc, EC)]= (data['%d_ODFM_%s'% (perc, BSG)]+data['%d_ODFM_%s'% (perc, BSH)]+data['%d_ODFM_%s'% (perc, BSI)])
        data['%d_ODFM_%s'% (perc, EE)]= (data['%d_ODFM_%s'% (perc, BCA)]+data['%d_ODFM_%s'% (perc, BCB)]+data['%d_ODFM_%s'% (perc, BCC)]+data['%d_ODFM_%s'% (perc, BCD)])
        data['%d_ODFM_%s'% (perc, EF)]= (data['%d_ODFM_%s'% (perc, BSA)]+data['%d_ODFM_%s'% (perc, BSB)])
        data['%d_ODFM_%s'% (perc, EG)]= (data['%d_ODFM_%s'% (perc, EF)]/data['%d_ODFM_%s'% (perc, EA)]*100)
        
        data['%d_BDFM_%s'% (perc, EA)]= (data['%d_BDFM_%s'% (perc, BSD)]+data['%d_BDFM_%s'% (perc, BSE)]+data['%d_BDFM_%s'% (perc, BSF)])
        data['%d_BDFM_%s'% (perc, EB)]= (data['%d_BDFM_%s'% (perc, BSB)]/data['%d_BDFM_%s'% (perc, EA)]*100)
        data['%d_BDFM_%s'% (perc, EC)]= (data['%d_BDFM_%s'% (perc, BSG)]+data['%d_BDFM_%s'% (perc, BSH)]+data['%d_BDFM_%s'% (perc, BSI)])
        data['%d_BDFM_%s'% (perc, EE)]= (data['%d_BDFM_%s'% (perc, BCA)]+data['%d_BDFM_%s'% (perc, BCB)]+data['%d_BDFM_%s'% (perc, BCC)]+data['%d_BDFM_%s'% (perc, BCD)])
        data['%d_BDFM_%s'% (perc, EF)]= (data['%d_BDFM_%s'% (perc, BSA)]+data['%d_BDFM_%s'% (perc, BSB)])
        data['%d_BDFM_%s'% (perc, EG)]= (data['%d_BDFM_%s'% (perc, EF)]/data['%d_BDFM_%s'% (perc, EA)]*100)
        
        data['%d_TDCM_%s'% (perc, EA)]= (data['%d_TDCM_%s'% (perc, BSD)]+data['%d_TDCM_%s'% (perc, BSE)]+data['%d_TDCM_%s'% (perc, BSF)])
        data['%d_TDCM_%s'% (perc, EB)]= (data['%d_TDCM_%s'% (perc, BSB)]/data['%d_TDCM_%s'% (perc, EA)]*100)
        data['%d_TDCM_%s'% (perc, EC)]= (data['%d_TDCM_%s'% (perc, BSG)]+data['%d_TDCM_%s'% (perc, BSH)]+data['%d_TDCM_%s'% (perc, BSI)])
        data['%d_TDCM_%s'% (perc, EE)]= (data['%d_TDCM_%s'% (perc, BCA)]+data['%d_TDCM_%s'% (perc, BCB)]+data['%d_TDCM_%s'% (perc, BCC)]+data['%d_TDCM_%s'% (perc, BCD)])
        data['%d_TDCM_%s'% (perc, EF)]= (data['%d_TDCM_%s'% (perc, BSA)]+data['%d_TDCM_%s'% (perc, BSB)])
        data['%d_TDCM_%s'% (perc, EG)]= (data['%d_TDCM_%s'% (perc, EF)]/data['%d_TDCM_%s'% (perc, EA)]*100)
        
        data['%d_ODCM_%s'% (perc, EA)]= (data['%d_ODCM_%s'% (perc, BSD)]+data['%d_ODCM_%s'% (perc, BSE)]+data['%d_ODCM_%s'% (perc, BSF)])
        data['%d_ODCM_%s'% (perc, EB)]= (data['%d_ODCM_%s'% (perc, BSB)]/data['%d_ODCM_%s'% (perc, EA)]*100)
        data['%d_ODCM_%s'% (perc, EC)]= (data['%d_ODCM_%s'% (perc, BSG)]+data['%d_ODCM_%s'% (perc, BSH)]+data['%d_ODCM_%s'% (perc, BSI)])
        data['%d_ODCM_%s'% (perc, EE)]= (data['%d_ODCM_%s'% (perc, BCA)]+data['%d_ODCM_%s'% (perc, BCB)]+data['%d_ODCM_%s'% (perc, BCC)]+data['%d_ODCM_%s'% (perc, BCD)])
        data['%d_ODCM_%s'% (perc, EF)]= (data['%d_ODCM_%s'% (perc, BSA)]+data['%d_ODCM_%s'% (perc, BSB)])
        data['%d_ODCM_%s'% (perc, EG)]= (data['%d_ODCM_%s'% (perc, EF)]/data['%d_ODCM_%s'% (perc, EA)]*100)
        
        data['%d_BDCM_%s'% (perc, EA)]= (data['%d_BDCM_%s'% (perc, BSD)]+data['%d_BDCM_%s'% (perc, BSE)]+data['%d_BDCM_%s'% (perc, BSF)])
        data['%d_BDCM_%s'% (perc, EB)]= (data['%d_BDCM_%s'% (perc, BSB)]/data['%d_BDCM_%s'% (perc, EA)]*100)
        data['%d_BDCM_%s'% (perc, EC)]= (data['%d_BDCM_%s'% (perc, BSG)]+data['%d_BDCM_%s'% (perc, BSH)]+data['%d_BDCM_%s'% (perc, BSI)])
        data['%d_BDCM_%s'% (perc, EE)]= (data['%d_BDCM_%s'% (perc, BCA)]+data['%d_BDCM_%s'% (perc, BCB)]+data['%d_BDCM_%s'% (perc, BCC)]+data['%d_BDCM_%s'% (perc, BCD)])
        data['%d_BDCM_%s'% (perc, EF)]= (data['%d_BDCM_%s'% (perc, BSA)]+data['%d_BDCM_%s'% (perc, BSB)])
        data['%d_BDCM_%s'% (perc, EG)]= (data['%d_BDCM_%s'% (perc, EF)]/data['%d_BDCM_%s'% (perc, EA)]*100)
    ...
    for position, col_name in enumerate(list_behaviors_social): 
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_TDCR_%s'% (perc, col_name)]=(data['%d_TDCF_%s'% (perc, col_name)]+data['%d_TDCM_%s'% (perc, col_name)])
            data['%d_TDFR_%s'% (perc, col_name)]=(data['%d_TDFF_%s'% (perc, col_name)]+data['%d_TDFM_%s'% (perc, col_name)])
        
        data['%d_TDCR_%s'% (perc, EA)]=(data['%d_TDCF_%s'% (perc, EA)]+data['%d_TDCM_%s'% (perc, EA)])
        data['%d_TDFR_%s'% (perc, EA)]=(data['%d_TDFF_%s'% (perc, EA)]+data['%d_TDFM_%s'% (perc, EA)])
        data['%d_TDCR_%s'% (perc, EB)]=(data['%d_TDCF_%s'% (perc, EB)]+data['%d_TDCM_%s'% (perc, EB)])
        data['%d_TDFR_%s'% (perc, EB)]=(data['%d_TDFF_%s'% (perc, EB)]+data['%d_TDFM_%s'% (perc, EB)])
        data['%d_TDCR_%s'% (perc, EC)]=(data['%d_TDCF_%s'% (perc, EC)]+data['%d_TDCM_%s'% (perc, EC)])
        data['%d_TDFR_%s'% (perc, EC)]=(data['%d_TDFF_%s'% (perc, EC)]+data['%d_TDFM_%s'% (perc, EC)])
        data['%d_TDCR_%s'% (perc, EE)]=(data['%d_TDCF_%s'% (perc, EE)]+data['%d_TDCM_%s'% (perc, EE)])
        data['%d_TDFR_%s'% (perc, EE)]=(data['%d_TDFF_%s'% (perc, EE)]+data['%d_TDFM_%s'% (perc, EE)])
        data['%d_TDCR_%s'% (perc, EF)]=(data['%d_TDCF_%s'% (perc, EF)]+data['%d_TDCM_%s'% (perc, EF)])
        data['%d_TDFR_%s'% (perc, EF)]=(data['%d_TDFF_%s'% (perc, EF)]+data['%d_TDFM_%s'% (perc, EF)])
        data['%d_TDCR_%s'% (perc, EG)]=(data['%d_TDCF_%s'% (perc, EG)]+data['%d_TDCM_%s'% (perc, EG)])
        data['%d_TDFR_%s'% (perc, EG)]=(data['%d_TDFF_%s'% (perc, EG)]+data['%d_TDFM_%s'% (perc, EG)])
    ...
    for position, col_name in enumerate(list_behaviors_social): 
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_TDM_%s'% (perc, col_name)]=(data['%d_TDCM_%s'% (perc, col_name)]+data['%d_TDFM_%s'% (perc, col_name)])
            data['%d_TDF_%s'% (perc, col_name)]=(data['%d_TDFF_%s'% (perc, col_name)]+data['%d_TDCF_%s'% (perc, col_name)])

    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_TDM_%s'% (perc, EA)]=(data['%d_TDCM_%s'% (perc, EA)]+data['%d_TDFM_%s'% (perc, EA)])
        data['%d_TDF_%s'% (perc, EA)]=(data['%d_TDFF_%s'% (perc, EA)]+data['%d_TDCF_%s'% (perc, EA)])
        data['%d_TDM_%s'% (perc, EB)]=(data['%d_TDCM_%s'% (perc, EB)]+data['%d_TDFM_%s'% (perc, EB)])
        data['%d_TDF_%s'% (perc, EB)]=(data['%d_TDFF_%s'% (perc, EB)]+data['%d_TDCF_%s'% (perc, EB)])
        data['%d_TDM_%s'% (perc, EC)]=(data['%d_TDCM_%s'% (perc, EC)]+data['%d_TDFM_%s'% (perc, EC)])
        data['%d_TDF_%s'% (perc, EC)]=(data['%d_TDFF_%s'% (perc, EC)]+data['%d_TDCF_%s'% (perc, EC)])
        data['%d_TDM_%s'% (perc, EE)]=(data['%d_TDCM_%s'% (perc, EE)]+data['%d_TDFM_%s'% (perc, EE)])
        data['%d_TDF_%s'% (perc, EE)]=(data['%d_TDFF_%s'% (perc, EE)]+data['%d_TDCF_%s'% (perc, EE)])
        data['%d_TDM_%s'% (perc, EF)]=(data['%d_TDCM_%s'% (perc, EF)]+data['%d_TDFM_%s'% (perc, EF)])
        data['%d_TDF_%s'% (perc, EF)]=(data['%d_TDFF_%s'% (perc, EF)]+data['%d_TDCF_%s'% (perc, EF)])
        data['%d_TDM_%s'% (perc, EG)]=(data['%d_TDCM_%s'% (perc, EG)]+data['%d_TDFM_%s'% (perc, EG)])
        data['%d_TDF_%s'% (perc, EG)]=(data['%d_TDFF_%s'% (perc, EG)]+data['%d_TDCF_%s'% (perc, EG)])
    ...
    for position, col_name in enumerate(list_behaviors_social): 
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_BDCR_%s'% (perc, col_name)]=(data['%d_BDCF_%s'% (perc, col_name)]+data['%d_BDCM_%s'% (perc, col_name)])
            data['%d_BDFR_%s'% (perc, col_name)]=(data['%d_BDFF_%s'% (perc, col_name)]+data['%d_BDFM_%s'% (perc, col_name)])

    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_BDCR_%s'% (perc, EA)]=(data['%d_BDCF_%s'% (perc, EA)]+data['%d_BDCM_%s'% (perc, EA)])
        data['%d_BDFR_%s'% (perc, EA)]=(data['%d_BDFF_%s'% (perc, EA)]+data['%d_BDFM_%s'% (perc, EA)])
        data['%d_BDCR_%s'% (perc, EB)]=(data['%d_BDCF_%s'% (perc, EB)]+data['%d_BDCM_%s'% (perc, EB)])
        data['%d_BDFR_%s'% (perc, EB)]=(data['%d_BDFF_%s'% (perc, EB)]+data['%d_BDFM_%s'% (perc, EB)])
        data['%d_BDCR_%s'% (perc, EC)]=(data['%d_BDCF_%s'% (perc, EC)]+data['%d_BDCM_%s'% (perc, EC)])
        data['%d_BDFR_%s'% (perc, EC)]=(data['%d_BDFF_%s'% (perc, EC)]+data['%d_BDFM_%s'% (perc, EC)])
        data['%d_BDCR_%s'% (perc, EE)]=(data['%d_BDCF_%s'% (perc, EE)]+data['%d_BDCM_%s'% (perc, EE)])
        data['%d_BDFR_%s'% (perc, EE)]=(data['%d_BDFF_%s'% (perc, EE)]+data['%d_BDFM_%s'% (perc, EE)])
        data['%d_BDCR_%s'% (perc, EF)]=(data['%d_BDCF_%s'% (perc, EF)]+data['%d_BDCM_%s'% (perc, EF)])
        data['%d_BDFR_%s'% (perc, EF)]=(data['%d_BDFF_%s'% (perc, EF)]+data['%d_BDFM_%s'% (perc, EF)])
        data['%d_BDCR_%s'% (perc, EG)]=(data['%d_BDCF_%s'% (perc, EG)]+data['%d_BDCM_%s'% (perc, EG)])
        data['%d_BDFR_%s'% (perc, EG)]=(data['%d_BDFF_%s'% (perc, EG)]+data['%d_BDFM_%s'% (perc, EG)])
    ...
    for position, col_name in enumerate(list_behaviors_social): 
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_BDM_%s'% (perc, col_name)]=(data['%d_BDCM_%s'% (perc, col_name)]+data['%d_BDFM_%s'% (perc, col_name)])
            data['%d_BDF_%s'% (perc, col_name)]=(data['%d_BDFF_%s'% (perc, col_name)]+data['%d_BDCF_%s'% (perc, col_name)])

    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_BDM_%s'% (perc, EA)]=(data['%d_BDCM_%s'% (perc, EA)]+data['%d_BDFM_%s'% (perc, EA)])
        data['%d_BDF_%s'% (perc, EA)]=(data['%d_BDFF_%s'% (perc, EA)]+data['%d_BDCF_%s'% (perc, EA)])
        data['%d_BDM_%s'% (perc, EB)]=(data['%d_BDCM_%s'% (perc, EB)]+data['%d_BDFM_%s'% (perc, EB)])
        data['%d_BDF_%s'% (perc, EB)]=(data['%d_BDFF_%s'% (perc, EB)]+data['%d_BDCF_%s'% (perc, EB)])
        data['%d_BDM_%s'% (perc, EC)]=(data['%d_BDCM_%s'% (perc, EC)]+data['%d_BDFM_%s'% (perc, EC)])
        data['%d_BDF_%s'% (perc, EC)]=(data['%d_BDFF_%s'% (perc, EC)]+data['%d_BDCF_%s'% (perc, EC)])
        data['%d_BDM_%s'% (perc, EE)]=(data['%d_BDCM_%s'% (perc, EE)]+data['%d_BDFM_%s'% (perc, EE)])
        data['%d_BDF_%s'% (perc, EE)]=(data['%d_BDFF_%s'% (perc, EE)]+data['%d_BDCF_%s'% (perc, EE)])
        data['%d_BDM_%s'% (perc, EF)]=(data['%d_BDCM_%s'% (perc, EF)]+data['%d_BDFM_%s'% (perc, EF)])
        data['%d_BDF_%s'% (perc, EF)]=(data['%d_BDFF_%s'% (perc, EF)]+data['%d_BDCF_%s'% (perc, EF)])
        data['%d_BDM_%s'% (perc, EG)]=(data['%d_BDCM_%s'% (perc, EG)]+data['%d_BDFM_%s'% (perc, EG)])
        data['%d_BDF_%s'% (perc, EG)]=(data['%d_BDFF_%s'% (perc, EG)]+data['%d_BDCF_%s'% (perc, EG)])
    ...
    for position, col_name in enumerate(list_behaviors_social): 
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_ODCR_%s'% (perc, col_name)]=(data['%d_ODCF_%s'% (perc, col_name)]+data['%d_ODCM_%s'% (perc, col_name)])
            data['%d_ODFR_%s'% (perc, col_name)]=(data['%d_ODFF_%s'% (perc, col_name)]+data['%d_ODFM_%s'% (perc, col_name)])

    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_ODCR_%s'% (perc, EA)]=(data['%d_ODCF_%s'% (perc, EA)]+data['%d_ODCM_%s'% (perc, EA)])
        data['%d_ODFR_%s'% (perc, EA)]=(data['%d_ODFF_%s'% (perc, EA)]+data['%d_ODFM_%s'% (perc, EA)])
        data['%d_ODCR_%s'% (perc, EB)]=(data['%d_ODCF_%s'% (perc, EB)]+data['%d_ODCM_%s'% (perc, EB)])
        data['%d_ODFR_%s'% (perc, EB)]=(data['%d_ODFF_%s'% (perc, EB)]+data['%d_ODFM_%s'% (perc, EB)])
        data['%d_ODCR_%s'% (perc, EC)]=(data['%d_ODCF_%s'% (perc, EC)]+data['%d_ODCM_%s'% (perc, EC)])
        data['%d_ODFR_%s'% (perc, EC)]=(data['%d_ODFF_%s'% (perc, EC)]+data['%d_ODFM_%s'% (perc, EC)])
        data['%d_ODCR_%s'% (perc, EE)]=(data['%d_ODCF_%s'% (perc, EE)]+data['%d_ODCM_%s'% (perc, EE)])
        data['%d_ODFR_%s'% (perc, EE)]=(data['%d_ODFF_%s'% (perc, EE)]+data['%d_ODFM_%s'% (perc, EE)])
        data['%d_ODCR_%s'% (perc, EF)]=(data['%d_ODCF_%s'% (perc, EF)]+data['%d_ODCM_%s'% (perc, EF)])
        data['%d_ODFR_%s'% (perc, EF)]=(data['%d_ODFF_%s'% (perc, EF)]+data['%d_ODFM_%s'% (perc, EF)])
        data['%d_ODCR_%s'% (perc, EG)]=(data['%d_ODCF_%s'% (perc, EG)]+data['%d_ODCM_%s'% (perc, EG)])
        data['%d_ODFR_%s'% (perc, EG)]=(data['%d_ODFF_%s'% (perc, EG)]+data['%d_ODFM_%s'% (perc, EG)])
    ...
    for position, col_name in enumerate(list_behaviors_social): 
        # Calculate total number of each behavior per rat in total environment for each interval
        for rank, perc in enumerate(list_intervals):
            data['%d_ODM_%s'% (perc, col_name)]=(data['%d_ODCM_%s'% (perc, col_name)]+data['%d_ODFM_%s'% (perc, col_name)])
            data['%d_ODF_%s'% (perc, col_name)]=(data['%d_ODFF_%s'% (perc, col_name)]+data['%d_ODCF_%s'% (perc, col_name)])

    # Calculate total number of each behavior per rat in total environment for each interval
    for rank, perc in enumerate(list_intervals):
        
        data['%d_ODM_%s'% (perc, EA)]=(data['%d_ODCM_%s'% (perc, EA)]+data['%d_ODFM_%s'% (perc, EA)])
        data['%d_ODF_%s'% (perc, EA)]=(data['%d_ODFF_%s'% (perc, EA)]+data['%d_ODCF_%s'% (perc, EA)])
        data['%d_ODM_%s'% (perc, EB)]=(data['%d_ODCM_%s'% (perc, EB)]+data['%d_ODFM_%s'% (perc, EB)])
        data['%d_ODF_%s'% (perc, EB)]=(data['%d_ODFF_%s'% (perc, EB)]+data['%d_ODCF_%s'% (perc, EB)])
        data['%d_ODM_%s'% (perc, EC)]=(data['%d_ODCM_%s'% (perc, EC)]+data['%d_ODFM_%s'% (perc, EC)])
        data['%d_ODF_%s'% (perc, EC)]=(data['%d_ODFF_%s'% (perc, EC)]+data['%d_ODCF_%s'% (perc, EC)])
        data['%d_ODM_%s'% (perc, EE)]=(data['%d_ODCM_%s'% (perc, EE)]+data['%d_ODFM_%s'% (perc, EE)])
        data['%d_ODF_%s'% (perc, EE)]=(data['%d_ODFF_%s'% (perc, EE)]+data['%d_ODCF_%s'% (perc, EE)])
        data['%d_ODM_%s'% (perc, EF)]=(data['%d_ODCM_%s'% (perc, EF)]+data['%d_ODFM_%s'% (perc, EF)])
        data['%d_ODF_%s'% (perc, EF)]=(data['%d_ODFF_%s'% (perc, EF)]+data['%d_ODCF_%s'% (perc, EF)])
        data['%d_ODM_%s'% (perc, EG)]=(data['%d_ODCM_%s'% (perc, EG)]+data['%d_ODFM_%s'% (perc, EG)])
        data['%d_ODF_%s'% (perc, EG)]=(data['%d_ODFF_%s'% (perc, EG)]+data['%d_ODCF_%s'% (perc, EG)])
...
list_df_results=[results_all_TD_mod,results_all_OD_mod,results_all_BD_mod,
                 results_CB1_TD_mod,results_CB1_OD_mod,results_CB1_BD_mod,
                 results_CB2_TD_mod,results_CB2_OD_mod,results_CB2_BD_mod,
                 results_CB3_TD_mod,results_CB3_OD_mod,results_CB3_BD_mod,
                 results_CB4_TD_mod,results_CB4_OD_mod,results_CB4_BD_mod,
                 results_CB5_TD_mod,results_CB5_OD_mod,results_CB5_BD_mod,
                 results_CB6_TD_mod,results_CB6_OD_mod,results_CB6_BD_mod,
                 results_MAB_TD_mod,results_MAB_OD_mod,results_CB6_BD_mod,
                 results_all_TD_modtreat,results_all_OD_modtreat,results_all_BD_modtreat,
                 results_CB1_TD_modtreat,results_CB1_OD_modtreat,results_CB1_BD_modtreat,
                 results_CB2_TD_modtreat,results_CB2_OD_modtreat,results_CB2_BD_modtreat,
                 results_CB3_TD_modtreat,results_CB3_OD_modtreat,results_CB3_BD_modtreat,
                 results_CB4_TD_modtreat,results_CB4_OD_modtreat,results_CB4_BD_modtreat,
                 results_CB5_TD_modtreat,results_CB5_OD_modtreat,results_CB5_BD_modtreat,
                 results_CB6_TD_modtreat,results_CB6_OD_modtreat,results_CB6_BD_modtreat,
                 results_MAB_TD_modtreat,results_MAB_OD_modtreat,results_MAB_BD_modtreat]
...
list_mean_titles=['mean_all_TD_mod','mean_all_OD_mod','mean_all_BD_mod',
                 'mean_CB1_TD_mod','mean_CB1_OD_mod','mean_CB1_BD_mod',
                 'mean_CB2_TD_mod','mean_CB2_OD_mod','mean_CB2_BD_mod',
                 'mean_CB3_TD_mod','mean_CB3_OD_mod','mean_CB3_BD_mod',
                 'mean_CB4_TD_mod','mean_CB4_OD_mod','mean_CB4_BD_mod',
                 'mean_CB5_TD_mod','mean_CB5_OD_mod','mean_CB5_BD_mod',
                 'mean_CB6_TD_mod','mean_CB6_OD_mod','mean_CB6_BD_mod',
                 'mean_MAB_TD_mod','mean_MAB_OD_mod','mean_MAB_BD_mod',
                 'mean_all_TD_modtreat','mean_all_OD_modtreat','mean_all_BD_modtreat',
                 'mean_CB1_TD_modtreat','mean_CB1_OD_modtreat','mean_CB1_BD_modtreat',
                 'mean_CB2_TD_modtreat','mean_CB2_OD_modtreat','mean_CB2_BD_modtreat',
                 'mean_CB3_TD_modtreat','mean_CB3_OD_modtreat','mean_CB3_BD_modtreat',
                 'mean_CB4_TD_modtreat','mean_CB4_OD_modtreat','mean_CB4_BD_modtreat',
                 'mean_CB5_TD_modtreat','mean_CB5_OD_modtreat','mean_CB5_BD_modtreat',
                 'mean_CB6_TD_modtreat','mean_CB6_OD_modtreat','mean_CB6_BD_modtreat',
                 'mean_MAB_TD_modtreat','mean_MAB_OD_modtreat','mean_MAB_BD_modtreat']
